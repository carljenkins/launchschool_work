...
puts
#Question 3
# my_string still displays pumpkins becuase the method
# creates a new varaible called a_string_param and assinged
# 'rutabaga' to it. Which leaves the orignal variable of my_string still
# pointing to the pumpkins value.
# Passing an array of pumpkins to the method and the use of the << method
# modified the orignal array which means out array now contains two values.
